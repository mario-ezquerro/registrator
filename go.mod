...
replace github.com/mario-ezquerro/registrator => ./
...
require (
	...
	github.com/mario-ezquerro/pkg v0.0.0-20161206023812-36f28d47ec7a
...
require (
	...
	golang.org/x/sys v0.21.0 // indirect; NOTA: Esta versión es un ejemplo, se actualizará con 'go mod tidy'
